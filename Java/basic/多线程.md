...
![image-20210204194431037](images/image-20210204194431037.png)
...
<img src="images/image-20210204195631268.png" alt="image-20210204195631268" style="zoom:80%;" />

- synchronized相当于一个门，一开始门是绿色的，锁是开的，t1,t2,t3三个线程可以抢占锁

<img src="images/image-20210204200022959.png" alt="image-20210204200022959" style="zoom:80%;" />

- 假如t1抢到了锁，t1进去了，会把门关上，图中锁的位置变成红色，这时其他线程就进不去了

- t1在里面执行自己的代码，这时候t1无论经历了什么比如阻塞、挂起

  <img src="images/image-20210204200202326.png" alt="image-20210204200202326" style="zoom:80%;" />

- t1执行完后退出，释放锁，将门打开，可以和其他线程竞争来得到锁进而执行

  <img src="images/image-20210204200344296.png" alt="image-20210204200344296" style="zoom:80%;" />
...
![image-20210204210939575](images/image-20210204210939575.png)
...
![image-20210204211245995](images/image-20210204211245995.png)
...
![image-20210206195954036](images/image-20210206195954036.png)
...
![image-20210206203309554](images/image-20210206203309554.png)
...
![image-20210206205339164](images/image-20210206205339164.png)
...
![image-20210206214248146](images/image-20210206214248146.png)
...
![image-20210209150434695](images/image-20210209150434695.png)
...
![image-20210209151713403](images/image-20210209151713403.png)